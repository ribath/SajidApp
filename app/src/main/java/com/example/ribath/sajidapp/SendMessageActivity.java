...
public class SendMessageActivity extends AppCompatActivity implements TextToSpeech.OnInitListener, TextToSpeech.OnUtteranceCompletedListener {
    ...
    int flag;
    String TAG = "SendMessageActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upperHalf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                saveMailInDB();
                Toast.makeText(SendMessageActivity.this, "sms is sent to " + receiverEmail,
    ...
    public void saveMailInDB()
    {
        ...
        MessageData sentMail = new MessageData(receiverEmail, emailBody, ""+System.currentTimeMillis());
        try {
            Dao<MessageData, String> SentMailDao = dbHelper.getMessageDataDao();
