...
public class ReceiveNumberActivity extends AppCompatActivity implements TextToSpeech.OnInitListener, TextToSpeech.OnUtteranceCompletedListener {
    ...
    int flag=1;
    String TAG = "ReceiveNumberActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        upperHalf.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ReceiveNumberActivity.this, SendMessageActivity.class);
