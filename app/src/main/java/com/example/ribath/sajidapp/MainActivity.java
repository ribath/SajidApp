...
public class MainActivity extends AppCompatActivity implements TextToSpeech.OnInitListener, TextToSpeech.OnUtteranceCompletedListener {
    ...
    String welcome_speech = "To send message say, \"send\", to go to inbox say, \"inbox\", to go to sent items say, \"sent items\", to launch other apps say, \"other\".";
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQ_CODE_SPEECH_INPUT)
        {
            ...
            if (resultCode == RESULT_OK && null != data)
            {
                ...
                {
                    welcome_text.setText("going to send message");
                    tts_flag = 2;
                    tts = new TextToSpeech(this, this);
                }
                ...
                {
                    welcome_text.setText("going sent items");
                    tts_flag = 4;
                    tts = new TextToSpeech(this, this);
                }
                else if (result.get(0).equals("other"))
                {
                    welcome_text.setText("going to others");
                    tts_flag = 5;
                    tts = new TextToSpeech(this, this);
                }
                else
    ...
    public void onInit(int status) {
        if (status == TextToSpeech.SUCCESS) {
            ...
            {
                tts.speak("going to send message", TextToSpeech.QUEUE_FLUSH, myHashAlarm);
            }
            else if (tts_flag==3)
            {
            ...
            {
                tts.speak("going to others", TextToSpeech.QUEUE_FLUSH, myHashAlarm);
            }
        }
    }
    ...
    public void onUtteranceCompleted(String s) {
        ...
        {
            //Log.i(TAG, "2e dhukse");
            Intent intent = new Intent(MainActivity.this, ReceiveNumberActivity.class);
